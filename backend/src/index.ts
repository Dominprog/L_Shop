...
const swaggerOptions: swaggerJsdoc.Options = {
  definition: {
    openapi: '3.0.0',
    info: { title: 'L_Shop API', version: '2.0.0', description: 'API интернет-магазина L_Shop' },
      ...
      schemas: {
        ...
        Comment: {
          ...
          properties: {
            ...
            userName: { type: 'string' }, productId: { type: 'string' },
            text: { type: 'string' }, rating: { type: 'number' }, createdAt: { type: 'string' },
          },
        },
